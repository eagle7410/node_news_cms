                ...
                <div class="col-md-3">
                    <md-field>
                        ...
                        <md-select v-model="is_deleted" id="byRemove">
                            <md-option :value="-1">{{__t('all')}}</md-option>
                            <md-option :value="0">{{__t('isNoDeleted')}}</md-option>
                            <md-option :value="1">{{__t('isDeleted')}}</md-option>
                        </md-select>
                    </md-field>
                </div>
            </div>
    ...
    export default {
        ...
        computed: {
            ...
            is_active: {
                ...
                set: function (value) {
                    this.$store.commit('setFilterIsActiveEmployees', value);
                }
            },
            is_deleted: {
                get: function () {
                ...
                set: function (value) {
                    this.$store.commit('setFilterIsDeleteEmployees', value);
                }
            }
        },
